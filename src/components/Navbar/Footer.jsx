        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div>
            <h3 className="text-white font-semibold mb-2">
              TM — Assignment System
            </h3>
            <p className="text-sm">
              TM Assignment system is a platform that centralizes, tracks, and
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>@TM — Assignment System</li>
              <li>@TM — Assignment System</li>
              <li>@TM — Assignment System</li>
              <li>support@tm.com</li>
            </ul>
          </div>
        </div>
        <div className="text-left md:text-center text-gray-500 text-sm mt-8">
          © 2025 TM — Assignment System.
